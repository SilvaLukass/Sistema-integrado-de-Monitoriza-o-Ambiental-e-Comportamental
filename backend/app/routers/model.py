...
from ..services.sensor_filter import clean_data, data_validation
...
def _predict_from_model(
    ...
    df_processed = clean_data(readings, feature_cols) #Função que limpa os dados e cria as features temporais
