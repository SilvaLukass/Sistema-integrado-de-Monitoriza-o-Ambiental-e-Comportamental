      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-4">
            ...
            <p className="text-xs text-[#6a7282] shrink-0">{alert.timestamp}</p>
          </div>
...
export default function AlertsPage() {
  ...
  // useAppStore com seletor — só re-renderiza quando os alerts mudarem, senão dava re-render ao componente com qualquer mudança no store
  const alerts = useAppStore((state) => state.alerts)

  const mockAlerts: Alert[] = alerts.length > 0 ? alerts : [
    {
      id: '1',
